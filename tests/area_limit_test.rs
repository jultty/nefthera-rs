...
fn cant_move_beyond_area_limits() {
    ...
    let mut go_instruction = Instruction::new_move_instruction(true, world.clone(), 0, y_shift, 0);
    ...
    go_instruction = Instruction::new_move_instruction(true, world.clone(), 0, -1, 0);
    ian.go(go_instruction);
    assert_eq!(ian.position.x, initial_x_position);
    assert_eq!(ian.position.y, initial_y_position + y_shift);
    assert_eq!(ian.position.z, initial_z_position);
    ...
    go_instruction = Instruction::new_move_instruction(true, world.clone(), 0, -3, 0);
    ian.go(go_instruction);
    assert_eq!(ian.position.x, initial_x_position);
    assert_eq!(ian.position.y, initial_y_position + y_shift);
    assert_eq!(ian.position.z, initial_z_position);
    ...
    go_instruction = Instruction::new_move_instruction(true, world.clone(), 100000, 0, 0);
    ian.go(go_instruction);
    assert_eq!(ian.position.x, initial_x_position);
    ...
    go_instruction = Instruction::new_move_instruction(
        ...
        0,
        0,
        ian.position.area.limits.max_z - 1,
    );
    ian.go(go_instruction);
