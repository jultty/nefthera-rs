...
fn cant_move_beyond_area_limits() {
    ...
    let mut go_instruction = Instruction::new_move_instruction(true, 0, y_shift, 0, &entities);
    ...
    go_instruction = Instruction::new_move_instruction(true, 0, -1, 0, &entities);
    ian.go(go_instruction);
    assert_eq!(ian.position.x, initial_x_position);
    assert_eq!(ian.position.y, initial_y_position + y_shift);
    assert_eq!(ian.position.z, initial_z_position);
    ...
    go_instruction = Instruction::new_move_instruction(true, 0, -3, 0, &entities);
    ian.go(go_instruction);
    assert_eq!(ian.position.x, initial_x_position);
    assert_eq!(ian.position.y, initial_y_position + y_shift);
    assert_eq!(ian.position.z, initial_z_position);
    ...
    go_instruction = Instruction::new_move_instruction(true, 100000, 0, 0, &entities);
    ian.go(go_instruction);
    assert_eq!(ian.position.x, initial_x_position);
